  ...
  policy = jsonencode(
    {
      ...
      Statement = [
        {
          Effect   = "Allow"
          Action   = ["s3:ListBucket", "s3:GetBucketCORS", "s3:GetBucketPolicy", "s3:GetBucketVersioning", "s3:GetEncryptionConfiguration", "s3:GetBucketPublicAccessBlock", "s3:GetBucketAcl"]
  ...
  policy = jsonencode(
    {
      ...
      Statement = [
        {
          Effect   = "Allow"
          Action   = ["s3:ListBucket", "s3:GetBucketCORS", "s3:GetBucketPolicy", "s3:PutBucketPolicy", "s3:PutBucketVersioning", "s3:GetBucketVersioning", "s3:GetEncryptionConfiguration", "s3:GetBucketPublicAccessBlock", "s3:GetBucketAcl"]
          Resource = "arn:aws:s3:::${var.crc_s3_bucket}"
          }, {
          Effect   = "Allow"
          Action   = ["s3:GetObject", "s3:PutObject"]
